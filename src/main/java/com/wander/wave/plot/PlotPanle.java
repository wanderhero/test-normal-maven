...
import com.wander.wave.plot.model.DrawableAttribute;
import com.wander.wave.plot.model.DrawableObject;
...
public class PlotPanle extends JPanel {
	 ...
	 * @param x 参考横坐标
	 * @param y 参考纵坐标
	 * @param scalex 横向倍数，1为不缩放，>1放大，<1缩小，不能为0
	 * @param scaley 纵向倍数，1为不缩放，>1放大，<1缩小，不能为0
	 */
